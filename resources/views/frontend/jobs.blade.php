    ...
    <div class="container col-xxl-8 px-4 py-5">
        <div class="row flex-lg-row-reverse align-items-center g-5 py-4">
            <div class="col-lg-12" style="margin-top: 0px;">
                <center>
                    <h1 class="display-3 fw-bold lh-1 mb-3">Jobs Board</h1> 
                    <h3 style="font-size:25px;position:relative;bottom:10px">(API sourced jobs list)</h3>  
                </center>      
            </div>
            ...
            <div class="col-lg-8" style="margin-top:10px">
                <p class="lead">
                    <i style="font-size:16px">
                       This is a mini project to demonstrate Laravel BALL stack (Bootstrap, Alpine, Livewire, Laravel)
                    </i>
                </p>
                <table style="width:100%;margin-bottom:5px">
                    <tr class="topalign">
                        <th><h4>Stack:</h4></th>
                        <th style="width:250px"><h4>Features:</h4></th>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <i class="fa-solid fa-thumbs-up" style="color:#acd3ac"></i> REST API<br>
                            <i class="fa-solid fa-thumbs-up" style="color:#acd3ac"></i> SPA functionality<br>
                            <i class="fa-solid fa-thumbs-up" style="color:#acd3ac"></i> Logged in users can save jobs<br>
                            <i class="fa-solid fa-thumbs-up" style="color:#acd3ac"></i> Source: <a href="https://remoteok.com">remoteok.com</a>
